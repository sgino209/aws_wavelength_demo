...
# ------------------------       -----------------------------------------
# | us-west-2 Region    |       | Wavelength Zone (San-Fransisco Bay)    |
# | -------------------------------------------------------------------- |
# | | VPC                |       |                                     | |
# | | ------------------ |       | ---------------------               | |
...
echo 'INFERENCE_SG_ID='$INFERENCE_SG_ID
...
echo 'WL_SUBNET_ID='$WL_SUBNET_ID
...
echo 'BASTION_SUBNET_ID='$BASTION_SUBNET_ID
...
echo 'BASTION_RT_ID='$BASTION_RT_ID
...
echo 'INFERENCE_CIP_ALLOC_ID='$INFERENCE_CIP_ALLOC_ID
...
echo 'API_CIP_ALLOC_ID='$API_CIP_ALLOC_ID
...
echo 'INFERENCE_ENI_ID='$INFERENCE_ENI_ID
...
# Deploy the inference instance (g4dn.2xlarge, AWS deep learning AMI):
...
# Issue the command below to create your bastion host (t3.medium, Ubuntu 18.04 AMI)
